import 'package:dorandoran/texting/post_datail/quest/post_detail_deletereply.dart';
...
class _ReplyCardState extends State<ReplyCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.isWrittenByMember==true)
        _menulist = ['삭제하기'];
                                      ...
                                      children:[
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                Expanded(child:Text( widget.replyAnonymityNickname ?? widget.replyNickname ,style: GoogleFonts.jua(fontSize: 17.sp),), ),
                                                DropdownButton2(
                                                            ...
                                                            return AlertDialog(
                                                              ...
                                                              actions: [
                                                                TextButton(
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    await deletereply(widget.replyId);
                                            ...
                                            Text(widget.replyCheckDelete?"!삭제된 댓글입니다!" :widget.reply!, style: GoogleFonts.jua(),),
                                            Row(
                                                children: [
